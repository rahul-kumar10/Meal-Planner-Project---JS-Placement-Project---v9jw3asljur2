...
function btnHandler_1() {
    if (document.querySelector("#recipe").getAttribute("class") == "btnHidden_1") {
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[0].id}/ingredientWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[0].id}/equipmentWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
            .then((response) => response.json())
            .then((data) => {
...
function btnHandler_2() {
    if (document.querySelector("#recipe").getAttribute("class") == "btnHidden_1") {
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[1].id}/ingredientWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
            .then((response) => response.json())
            .then((data) => {
                for (let i = 0; i < data.ingredients.length; i++) {
                    let ingredientValue = 0, ingredientUnit = "";
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[1].id}/equipmentWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
            .then((response) => response.json())
            .then((data) => {
                for (let i = 0; i < data.equipment.length; i++) {
                    let liTag = document.createElement("li");
...
function btnHandler_3() {
    ...
    if (document.querySelector("#recipe").getAttribute("class") == "btnHidden_1") {
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[2].id}/ingredientWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
            .then((response) => response.json())
            .then((data) => {
                for (let i = 0; i < data.ingredients.length; i++) {
                    let ingredientValue = 0, ingredientUnit = "";
        ...
        fetch(`https://api.spoonacular.com/recipes/${mealDataObj.meals[2].id}/equipmentWidget.json?apiKey=76c9afdf208349d78fbb7cb906d88409`)
            .then((response) => response.json())
            .then((data) => {
                for (let i = 0; i < data.equipment.length; i++) {
                    let liTag = document.createElement("li");
